...
> **Hit a snag?** Almost every common hiccup on this step (greyed-out buttons, "email already exists," can't move an account, can't rename) is covered in [`03-00-before-you-start.md`](03-00-before-you-start.md). Keep it open in a tab.
